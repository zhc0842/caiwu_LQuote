...
*
*序号    日期             版本                作者                         
*1.      2011.10.17       v1.0.0.1            顶点企业级证券集中交易系统ABOSS2
*    创建。
*
**********************************************************************/
...
#define  FID_CGJGDM             1577  //存管机构代码  DT：C  DT：在银行端保存的营业部编码  
...
#define  FID_ZDHBSL             2044  //最低合并数量  DT：最低子基金申报合并数量  
#define  FID_ZDCFSL             2045  //最低拆分数量  DT：最低主基金申报拆分数量  
#define  FID_RZSYLLFD           2046  //融资使用利率浮动  DT：R  
#define  FID_RQSYLLFD           2047  //融券使用利率浮动  DT：R  
#define  FID_RZEDLLFD           2048  //融资额度利率浮动  
#define  FID_RQEDLLFD           2049  //融券额度利率浮动  
...
#define  FID_OID                2077  //内部记录OID号  DT：I64  
#define  FID_LOG_POS            2078  //系统日志文件位置  DT：I  
#define  FID_INDEX              2079  //索引号  DT：I  
#define  FID_KSSBWTH_SZ         2080  //深圳起始申报委托号  DT：I  
...
#define  FID_ZQMZ               2525  //证券面值  DT：R  DT：为兼容，值为0时表示1.00  
...
#define  FID_HOSTID             4076  //主机编号  DT：N  
...
#define  FID_CDYY               9365  //撤单原因  DT：C  DT：给VIP成交触发使用  
#define  FID_ZXTBZ              9998  //主系统标志  DT：请不要使用这个断，特殊  
